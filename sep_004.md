...
| http://sbols.org/v2#verifyIdentical | Assert that the set of zero or more roles given for this `Component` is identical with the set of zero or more roles given for the child `ComponentDefinition`. Use that set. |
