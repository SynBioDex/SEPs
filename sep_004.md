...
For both proposed `roleIntegration` rule properties, either zero or one `<roleIntegration>` child element, if declared, MUST be contained within the parent element
in the XML serialized form.
