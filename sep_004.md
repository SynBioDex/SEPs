...
![Parent, siblings, and children in an SBOL part hierarchy.](~/SEP004.png "Parent, siblings, and children in an SBOL part hierarchy.")

Please note how we employ the labels "parent," "child," and "sibling" in the
context of the argument below.
