...
![Minimal workflow representation](images/sep_20_designbuildtest_min.png "Minimal workflow representation")
...
![Full workflow representation](images/sep_20_designbuildtest.png "Tentative full workflow representation")

**Example 2a:** A tentative full workflow representation. Prov-O activities provide an orthogonal layer of meta information on top of the native SBOL chain of objects. Note: the prov:usage terms "design", "build", "test", "learn" have been suggested in sboldev discussions and are defined in SEP 19. "biomaterial" would be a new term which, in my view, better represents the relation between experimental protocols and clones/batches.
