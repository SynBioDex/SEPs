...
#### 2.1.4 Link to Experimental Data <a name="experimental"></a>
...
#### 2.1.5 Link to assembly data <a name="assembly"></a>
...
In contrast to SEP 19, the use of prov-O vocabulary together with `Implementation` is encouraged but optional. Parsing of prov-O information MUST NOT be needed for the simple identification of a clone and neither for determining what structure (a.k.a. sequence) it is supposed to have. 
