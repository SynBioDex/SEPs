...
Note: In SEP 19, the recommended use of `Implementation.wasDerivedFrom` also includes links to the design `ComponentDefinition`. The current proposal only recommends `wasDerivedFrom` for the expression of physical clone / batch relationships. 
