...
In addition, it is possible to encode Example 3.1 using both the sourceLocation
property and Prov-O in a complementary fashion. In the UML object diagram below,
the insertion of a cargo ComponentDefinition into a backbone ComponentDefinition
