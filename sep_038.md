...
All other constraints on characters should be maintained as well: this SEP is not meant to weaken character constraints.
...
- TopLevel: `[domain]/[root]/[collection structure]/[displayId]`
  ...
  - Note that this means TopLevel URI structure can always be automatically decomposed with the aid of a NameSpace:
    - Example: "https://synbiohub.org/igem/2017\_distribution/promoters/constitutive/BBa\_J23101" might have namespace "https://synbiohub.org/igem/2017\_distribution", implying domain="https://synbiohub.org", root = "igem/2017\_distribution", collection = "promoters/constitutive" and displayId = "BBa_J23101"
