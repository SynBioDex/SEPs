...
In this example, it is not explicitly stated that the `id:Build_Activity` is the activity to transform the designed `id:CD` construct into a `id:Impl` implementation.
