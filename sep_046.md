...
* SBOL has been made more Semantic Web friendly. This includes: 
  * Differentiating SBOL entities (concepts) and properties
    * The `feature` field of `Component` has now been renamed to `hasFeature`
  * Consistent labelling of SBOL entities
    * For instance, Access values will be capitalised. E.g. 'public' has been changed to 'Public', 'private' has been changed to 'Private'    
...
* Experiment is a sub-class of Collection
