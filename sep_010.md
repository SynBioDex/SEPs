...
* [2. Specification](#specification)
  ...
  * 2.4 Allow SequenceConstraints to point to `SequenceFeature`
...
This backwards-incompatible changes would be introduced with SBOL 3.0
...
Phase 1: SBOL 2.x
  ...
  * allow `SequenceConstraint` to point to `SequenceAnnotation`
