...
Examples and use cases are embedded in the specification material given above. There are additional examples illustrated below using UML diagrams.

#### Composite Part <a name="assembly"></a>

![Composite Part Example UML diagram](images/sep_055_composite_part_example.png "Composite Part Example UML diagram")

**Figure 1:** UML diagram for first example of representing a composite part.

#### Assembly <a name="assembly"></a>

![Assembly Example UML diagram](images/sep_055_assembly_example.png "Assembly Example UML diagram")

**Figure 2:** UML diagram for first example of representing assembly.
