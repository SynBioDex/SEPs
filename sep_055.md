...
**Authors**           | Jacob Beal (jakebeal@ieee.org), Vinoo Selvarajah, Gael Chambonnier, Traci Haddock-Angelli, Alejandro Vignoni, Gonzalo Vidal
**Editor**            | 
**Type**               | Data Model
...
An assembled part within a composite part SHOULD be represented by including a `feature` in the composite `Component` that is a `SubComponent` with an `instanceOf` property that links to the `Component` for the part being assembled.
...
To indicate the relationship between each part and that part in backbone, the assembly plan SHOULD contain a `Constraint` with a `type` value of `contains`, the part in backbone as the value of `subject`, and the part as the value of `object`.
...
**Figure 2:** Composite part example UML diagram with Locations. SO:0001953 stands for restriction_enzyme_assembly_scar and SO:0000139 stands for ribosome_entry_site.

![composite_part](images/sep_055_composite_part_example_1.png "Composite part example UML diagram with Locations")

**Figure 3:** Composite part example UML diagram with Constraints. SO:0001953 stands for restriction_enzyme_assembly_scar and SO:0000139 stands for ribosome_entry_site.
...
**Figure 4:** Backbone example UML diagram with flanking sequences and Locations. The contents of BBa_G00000 are purposefully omitted for simplicity of presentation. SO:0001954 stands for restriction_enzyme_region, SO:0001687 stands for restriction_enzyme_recognition_site, and SO:0001692 stands for sticky_end_restriction_enzyme_cleavage_site. 

![backbone_2](images/sep_055_backbone_example_2.png "Backbone example UML diagram with flanking sequences and Constraints")

**Figure 5:** Backbone example UML diagram with flanking sequences and Constraints. The contents of BBa_G00000 are purposefully omitted for simplicity of presentation. SO:0001954 stands for restriction_enzyme_region, SO:0001687 stands for restriction_enzyme_recognition_site, and SO:0001692 stands for sticky_end_restriction_enzyme_cleavage_site.
...
**Figure 6:** Part in backbone example UML diagram with flanking sequences in backbone and Locations. The contents of BBa_G00000 and BBa_G00001 are purposefully omitted for simplicity of presentation. SO:0001954 stands for restriction_enzyme_region.
...
**Figure 7:** Part in backbone example UML diagram with flanking sequences in backbone and Constraints. The contents of BBa_G00000 and BBa_G00001 are purposefully omitted for simplicity of presentation. SO:0001954 stands for restriction_enzyme_region.
...
**Figure 8:** Part in backbone example UML diagram with flanking sequences in part insert and Locations. The contents of BBa_G00000 and BBa_G00001 are purposefully omitted for simplicity of presentation. SO:0001954 stands for restriction_enzyme_region.
...
**Figure 9:** Part in backbone example UML diagram with flanking sequences in part insert/extract and Locations. The contents of BBa_G00000 and BBa_G00001 are purposefully omitted for simplicity of presentation. SO:0001954 stands for restriction_enzyme_region, SO:0001692 stands for sticky_end_restriction_enzyme_cleavage_site, and SO:0001932 stands for restriction_enzyme_five_prime_single_strand_overhang.
...
**Figure 10:** Part extract example UML diagram with Locations.  SO:0001932 stands for restriction_enzyme_five_prime_single_strand_overhang.

![part_extract_2](images/sep_055_part_extract_example_2.png "Part extract example UML diagram with Constraints")

**Figure 11:** Part extract example UML diagram with Constraints. SO:0001932 stands for restriction_enzyme_five_prime_single_strand_overhang.
