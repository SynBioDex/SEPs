...
This specification considers all `sbol2:Identified` types to be potentially annotated with provenance information.
As such, the rdfs for `sbol2:Identified` is extended with:

```turtle
sbol2:TopLevel a prov:Entity
```
